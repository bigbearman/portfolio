...
window.PORTFOLIO_CONTENT = {
  ...
  nav: {
    en: { about: "about", skills: "skills", work: "work", projects: "projects", lab: "lab", contact: "contact", resume: "résumé.pdf" },
    vi: { about: "giới-thiệu", skills: "kỹ-năng", work: "kinh-nghiệm", projects: "dự-án", lab: "ai-lab", contact: "liên-hệ", resume: "cv.pdf" }
  },
  ...
  about: {
    en: {
      ...
      lines: [
        { kind: "h", text: "# About" },
        { kind: "p", text: "Senior Frontend Engineer with 10+ years building production web apps. I care about performance, scalable architecture, and the developer experience of the teams I work with." },
        { kind: "p", text: "Currently shipping an AI chatbot platform for healthcare (React + Laravel + pgvector) and running experiments with autonomous AI agent teams for dev workflow automation." },
        { kind: "p", text: "I've led small frontend teams, run code reviews and technical interviews, and shipped products end-to-end on my own. I write code that other people can pick up six months later without cursing me." },
    ...
    vi: {
      ...
      lines: [
        ...
        { kind: "p", text: "Kỹ sư Frontend Senior với hơn 10 năm xây dựng web app production. Mình quan tâm đến hiệu năng, kiến trúc có khả năng mở rộng và trải nghiệm của lập trình viên trong team." },
        { kind: "p", text: "Hiện đang phát triển nền tảng chatbot AI cho lĩnh vực y tế (React + Laravel + pgvector) và thử nghiệm hệ thống AI agent tự động cho workflow dev." },
        { kind: "p", text: "Mình đã dẫn dắt team frontend nhỏ, review code, phỏng vấn kỹ thuật và ship sản phẩm end-to-end một mình. Code mình viết để team đọc lại sau 6 tháng vẫn hiểu được, không cần chửi mình." },
  ...
  skills: {
    groups: [
      { key: "core", label: { en: "core", vi: "lõi" }, items: ["React.js", "Next.js", "TypeScript", "JavaScript ES2022+", "Vite"] },
      { key: "styling", label: { en: "styling", vi: "giao-diện" }, items: ["TailwindCSS", "CSS Modules", "SCSS", "Styled Components", "Figma"] },
      { key: "backend", label: { en: "backend", vi: "backend" }, items: ["Node.js", "NestJS", "Laravel", "Express", "REST", "GraphQL"] },
      { key: "ai", label: { en: "python · ai", vi: "python · ai" }, items: ["Python", "Claude API", "Anthropic SDK", "OpenAI API", "Prompt Engineering", "Agent Systems"] },
      { key: "data", label: { en: "data", vi: "dữ-liệu" }, items: ["PostgreSQL", "MySQL", "Redis", "pgvector"] },
      { key: "infra", label: { en: "infra · cloud", vi: "hạ-tầng" }, items: ["GCP", "AWS", "Vercel", "Docker", "Nginx", "GitHub Actions", "BullMQ"] },
      { key: "cms", label: { en: "cms · php", vi: "cms · php" }, items: ["Joomla CMS", "PHP", "WordPress"] },
      { key: "lead", label: { en: "leadership", vi: "lãnh-đạo" }, items: ["Code Review", "Architecture", "Tech Interviews", "Mentoring"] }
    ]
  },

  experience: [
    {
      role: { en: "Senior Frontend Engineer · Freelance", vi: "Senior Frontend Engineer · Freelance" },
      org: "Self-employed",
      where: "Remote",
  ...
  projects: [
    {
      status: "in-progress",
      name: "MedChat — AI for Healthcare",
      stack: ["React", "Laravel", "pgvector", "Claude API"],
      blurb: {
        en: "AI chatbot platform for healthcare. React frontend with streaming responses, Laravel backend, and pgvector for semantic search across medical knowledge base.",
        vi: "Nền tảng chatbot AI cho healthcare. Frontend React với streaming, backend Laravel và pgvector cho semantic search trên kho tri thức y khoa."
      },
      year: 2025
    },
    {
  ...
  contact: {
    en: {
      ...
      fields: { name: "your name", email: "your email", message: "what are you working on?" },
      send: "send message",
    ...
    vi: {
      ...
      fields: { name: "tên của bạn", email: "email của bạn", message: "bạn đang làm gì?" },
      send: "gửi tin nhắn",
  ...
  footer: {
    en: { built: "built with React, lots of coffee, and an unreasonable love for monospace fonts.", rights: "All rights reserved." },
    vi: { built: "xây bằng React, rất nhiều cà phê, và một tình yêu vô lý dành cho font monospace.", rights: "Mọi quyền được bảo lưu." }
  }
};
